...
public class ReadFile {
    ...
    public static void main(String[] args) {
        ...
        try {
            myFile = new FileReader("e3311_access_log2016-05-19.log");
...
//          ------------------------------------------------------------------------------
                ...
                // connect to db
                try {
                    con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db?useUnicode=true&characterEncoding=UTF-8&useSSL=false", "root", "zoot");
                    System.out.println("Inserting records into the table...");
                    stmt = con.createStatement();

                    sql = "INSERT INTO logdata1 VALUES ('" + matcher.group(1) + "', '" + matcher.group(2) + "', '" + matcher.group(3) + "','" + matcher.group(4) + "','" + matcher.group(5) + "','" + matcher.group(6) + "','" + matcher.group(7) + "','" + matcher.group(8) + "','" + matcher.group(9) + "','" + matcher.group(11) + "','" + matcher.group(12) + "','" + matcher.group(10) + "','" + matcher.group(11) + "','" + matcher.group(13) + "','" + matcher.group(14) + "','" + matcher.group(15) + "','" + matcher.group(16) + "','" + matcher.group(17) + "')";
